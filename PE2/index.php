...
<section class="main">
    <aside class="noticias">
        ...
        <section>
            <a href="noticias/noticia1.php">INSTRUCCIONES SOBRE USO DE LA MASCARILLA</a>
        </section>

        <section>
            <a href="noticias/noticia1.php">COMPRA DE ENDRADAS ONLINE</a>
        </section>

        <section>
            <a href="noticias/noticia1.php">INFORMACIÓN SOBRE LA DEVOLUCIÓN Y ANULACIÓN DE LAS RESERVAS</a>
        </section>
            ...
            foreach ($resultado as $fila) {
                echo '
                    <section class="exposiciones">
                        <section>
                        <a href="' . $fila["urlExp"] . '">
                            <img id="fotoexpo" src="' . $fila["urlImagen"] . '" title="' . $fila["titulo"] . ', ' . $fila["tipo"] . '">
                        </a>
                        <a href="' . $fila["urlExp"] . '">
                            <p id="tituloid">' . $fila["titulo"] . '</p>
                        </a>
                        <p id="tipoid">' . $fila["tipo"] . '</p>
                        <p> Fecha de exposición: <br> ' . $fila["fechaalta"] . ' - ' . $fila["fechabaja"] . '</p>
