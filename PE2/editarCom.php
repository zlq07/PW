...
<nav>
    <a href="index.php">Inicio</a> > <a href="editarCom.php">Editar datos</a>
</nav>
...
<section class="editar">
    <article>
        ...
        echo '<article>
        <form id="formulario" action="procesarEdiCom.php" method="post" name="formularioEdicionUsuario">
            <fieldset>
                ...
                <input type="text" id="dni" name="dni" value="' . $_SESSION['dni'] . '"/><br><br>

                <label for="telefono">Telefono *</label>
                <input type="text" id="telefono" name="telefono" value="' . $_SESSION['telefono'] . '"/><br><br>
            </fieldset>
            <br>
