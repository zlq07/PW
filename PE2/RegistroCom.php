...
<head>
    ...
    <title>Registro de Comisario</title>
</head>
...
<section style="clear: both;">
    ...
    ?>
    <form action="altaCom.php" method="post" name="formularioAltaComisario" onsubmit="return registerComisario();">
        <fieldset>
            ...
            <input type="text" id="DNI" name="DNI" onblur="validateDni()"/>
            <br><span id="dniMsg"></span><br/>

            <label for="telefono">Telefono de contacto *</label>
            <input type="tel" id="telefono" name="telefono" onblur="validateTelefono()"/>
